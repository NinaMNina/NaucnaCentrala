...
@Service
public class SlanjeOdbijenice implements JavaDelegate{
	@Autowired
	...
	public void execute(DelegateExecution execution) throws Exception {
        ...
        msg.setSubject("UPP2019: Odbijen rad");
        msg.setContent("Ovim mejlom se obaveštava autor rada o odbijuanju istog iz tehničkih razloga","text/html");
